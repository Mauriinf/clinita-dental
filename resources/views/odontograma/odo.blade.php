...
<head>
    ...
    <script src="{!! asset('odon/js/jquery-1.7.2.js') !!}"></script>
    <link type="text/css" href="{!! asset('odon/css/custom-theme/jquery-ui-1.8.13.custom.css') !!}" rel="stylesheet" />
    <script type="text/javascript" src="{!! asset('odon/js/jquery-ui-1.8.13.custom.min.js') !!}"></script>
    <style>
      #myCanvas {
