<div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class=" navigation-header"><span data-i18n="User Interface">Configuraciones</span><i data-feather="more-horizontal"></i>
            </li>
        
            <li class=" nav-item {{ $activePage == 'b_dia' ? ' active' : '' }} ">
                <a class="d-flex align-items-center" href="{{ route('bloque-dia.index') }}">
                    <i data-feather='calendar'></i><span class="menu-title text-truncate" data-i18n="Chat"></span>Configurar Agenda
                </a>
            </li>
        </ul>
    </div>
